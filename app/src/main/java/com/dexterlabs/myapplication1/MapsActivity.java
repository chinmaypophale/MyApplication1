        ...
        GoogleMap.OnMarkerDragListener */
{
    ...
    private String getDirectionsUrl()
    {
        ...
        googleDirectionsUrl.append("&key="+"AIzaSyDGwqNWB4CzqPIUBNrPqzp0_j9kBeZKky4");
                                                                            // AIzaSyCAcfy-02UHSu2F6WeQ1rhQhkCr51eBL9g     uski key
    ...
    private String getUrl(double latitude, double longitude, String nearbyPlace)
    {
        ...
        googlePlacesUrl.append("&sensor=true");                 //AIzaSyBj-cnmMUY21M0vnIKz0k3tD3bRdyZea-Y        uski key
        googlePlacesUrl.append("&key=" + "AIzaSyDGwqNWB4CzqPIUBNrPqzp0_j9kBeZKky4");
    ...
    public void onConnected(Bundle bundle) {
        ...
        if (ContextCompat.checkSelfPermission(this,
                Manifest.permission.ACCESS_FINE_LOCATION)
                == PackageManager.PERMISSION_GRANTED) {
            LocationServices.getFusedLocationProviderClient(MapsActivity.this);//requestLocationUpdates(mGoogleApiClient, mLocationRequest,  this);
        }
    }
    ...
    public void onLocationChanged(Location location) {
        ...
        if (mGoogleApiClient != null) {
            LocationServices.getFusedLocationProviderClient(MapsActivity.this);//FusedLocationApi.removeLocationUpdates(mGoogleApiClient, (com.google.android.gms.location.LocationListener) this);
